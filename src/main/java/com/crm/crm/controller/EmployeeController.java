...
public class EmployeeController {
   ...
   // http://localhost:8080/api/v1/employee?pageNo=0&pageSize=5&sortBy=emailId&sortDir=desc
    @GetMapping
    ...
    public ResponseEntity<EmployeeDto> getEmployeeId(@PathVariable long empId) {
